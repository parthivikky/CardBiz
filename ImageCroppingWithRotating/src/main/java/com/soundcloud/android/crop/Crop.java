...
public class Crop {
     ...
     * @param requestCode requestCode for result
     */
    public static void pickImage(Activity activity, int requestCode,Uri cameraUri) {
        try {
            activity.startActivityForResult(getPickImageChooserIntent(activity, cameraUri), requestCode);
        } catch (ActivityNotFoundException e) {
            showImagePickerError(activity);
        }
    }
    ...
    public static Intent getPickImageChooserIntent(Activity activity,Uri outputUri) {
