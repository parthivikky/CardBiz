...
public class TitlePageIndicator extends View implements PageIndicator {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //Calculate com.mobello.couriernow.views bounds
        ...
        //Left com.mobello.couriernow.views starting from the current position
        if (mCurrentPage > 0) {
        ...
        //Right com.mobello.couriernow.views starting from the current position
        ...
        //Now draw com.mobello.couriernow.views
    ...
    /**
     * Calculate com.mobello.couriernow.views bounds and scroll them according to the current index
     *
     * @param paint
     * @return
     */
    private ArrayList<Rect> calculateAllBounds(Paint paint) {
        ...
        //For each com.mobello.couriernow.views (If no values then add a fake one)
        final int count = mViewPager.getAdapter().getCount();
        final int width = getWidth();
