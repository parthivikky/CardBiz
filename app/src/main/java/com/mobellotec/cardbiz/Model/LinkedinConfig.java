...
/**
 * Created by Sai Sheshan on 28-Aug-15.
 */
public class LinkedinConfig {

    public static String LINKEDIN_CONSUMER_KEY = "75k2950lluwkf7";
    public static String LINKEDIN_CONSUMER_SECRET = "RKfDxu3UJmwymmPI";
